...
export const VNPAY = {
  // TMN_CODE: "TA3NS8OB",
  // HASH_SECRET: "LKDOQHXBLCWVQGDVXHETFBUHBGVISFIS",
  // VNP_URL: "https://sandbox.vnpayment.vn/paymentv2/vpcpay.html",
  // RETURN_URL: "http://localhost:3001/payment-return",
  TMN_CODE: "DNWLK9X7",
  HASH_SECRET: "CEPNVOHTPMMAAUGINMTLEDFQIPPKFBNR",
  VNP_URL: "https://sandbox.vnpayment.vn/paymentv2/vpcpay.html",
  RETURN_URL: "http://localhost:3001/payment-return",
};
...
export const MOMO = {
  //tuanvq72
  // PARTNER_CODE: "MOMO7WQC20220612",
  // ACCESS_KEY: "dfVC7zyMXiB6JdEf",
  // SECRET_KEY: "UXA6hD3Qh9jhaNuwuGMcFwFMkwROEeVL",
  // RETURN_URL: "http://localhost:3001/payment-return",
