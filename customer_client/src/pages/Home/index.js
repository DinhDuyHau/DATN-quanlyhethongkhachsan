...
const Home = () => {
  return (
    <Page title="Trang chủ | DH Hotel" style={{ paddingTop: 0 }}>
      {/* BANNER */}
      <Box
        sx={{
          width: "100%",
        ...
        <HalfFrame sx={{ backgroundColor: "#FBFBFB" }}>
          ...
          >
            ...
            <TypoStyle variant="body2">
              ...
              nghỉ của chúng tôi, DUYHAU HOTEL đã hỗ trợ chu đáo từ khi đón
              tại sân bay cho đến toàn bộ thời gian lưu trú tại khu nghỉ dưỡng.
              Đội ngũ nhân viên của DUYHAU HOTEL rất nhiệt tình, chuyên
            ...
            <TypoStyle variant="body2">
              ...
              hệ thống và nâng cấp dịch vụ, DUYHAU HOTEL đã thành công
      ...
      <Box style={{ width: "100%", backgroundColor: "#F4F4F4" }}>
        <Container maxWidth="xl">
          ...
          >
            ...
            <TypoStyle variant="body1">
              Tận hưởng mùa hè không thể nào quên cùng DUYHAU HOTEL, với
        ...
        <LeftResortFrame direction="row" alignItems="center">
          <InnerResortFrame direction="column" spacing={2} alignItems="center">
            ...
            <Typography variant="body2" color="#000" textAlign="center">
              Tận hưởng mùa hè không thể nào quên cùng DUYHAU HOTEL, với trải
